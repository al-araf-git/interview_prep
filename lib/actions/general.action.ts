...
export async function createFeedback(params: CreateFeedbackParams) {
    ...
    try {
        ...
        Please score the candidate from 0 to 100 in the following areas. Do not give marks to the missing section. Do not add categories other than the ones provided:
        ...
        return { success: true }
        // return { success: true, feedbackId: null };
